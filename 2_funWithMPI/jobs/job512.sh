...
make
rm -f generated/time512.dat
touch generated/time512.dat
echo '# nbProcs tSeq tPar' >> generated/time512.dat
tseq=`./simulator -i inputs/512.dat -s -r 0.01 -n 10000`
echo "1 ${tseq} ${tseq}" >> generated/time512.dat
for i in 2 4 8 16
do
  t=`mpiexec -n $i ./simulator -i inputs/512.dat -r 0.1 -n 10000 | head -n 1`
  echo "${i} ${tseq} ${t}" >> generated/time512.dat
done
