...
echo '# fineBlockSize tPdgetrf_nopiv' > Output/pdgetrf6.dat

for N in 10584 21168 30240 40824
do
	t=`MKL_NUM_THREADS=20 mpiexec -np 6 --bind-to none ./performance pdgetrf_nopiv ${N} ${N} -5 5 42 84 84 | sed -n 2p`
	echo "${N} ${t}" >> Output/pdgetrf6.dat
done
